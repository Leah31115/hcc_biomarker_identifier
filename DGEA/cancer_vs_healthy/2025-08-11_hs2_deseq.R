...
# Load in sample raw data hs2 matrix and coldata
count_data <- read.csv("C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/healthy_stage2_rawcounts.csv", row.names = 1)
condition <- read.csv("C:/Users/leahe/Documents/LIFE4137_independent_project/xena/clean_script/hs2/hs2_raw_col_data.csv", header = TRUE, row.names = 1)
...
res <- results(dds, name="condition_Stage2_HCC_vs_Healthy") # y (stage2) vs x control (healthy)
...
sum(res$padj < 0.01, na.rm=TRUE) # 15002
# Number of genes with padj < 0.05
sum(res$padj < 0.05, na.rm=TRUE) # 17810
...
which.min(res$padj) # 21429 -  gene
# log count statistics of the top differentially expressed gene
healthy_gene_count <- clean_d %>%
  filter(condition=="Healthy")
mean(healthy_gene_count[["count"]]) # 0.5
median(healthy_gene_count[["count"]])  # 0.5

stage2_gene_count <- clean_d %>%
  filter(condition=="Stage2_HCC")
mean(stage2_gene_count[["count"]]) # 10.52831
median(stage2_gene_count[["count"]]) # 10.53305
...
ggplot(data=volcano, aes(x=log2FoldChange, y=-log10(padj), col=diffexpressed, label=label)) +
  ...
  ylim(-5, 200) +
  xlim(-10, 10) +
  geom_text_repel(max.overlaps = Inf, size = 3, col = "black", force = 20)
...
fit
write.csv(as.data.frame(upreg_GO),file="C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/GO_analysis/upreg/hs2_upreg.csv")
...
fit
write.csv(as.data.frame(downreg_GO),file="C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/GO_analysis/downreg/hs2_downreg.csv")
...
write.table(upreg_20["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_upreg_20_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_50["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_upreg_50_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_10["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_upreg_10_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)

# summary of Top 10 upregulated significant genes (padj < 0.05)
upreg_sum <- upreg_10 %>%
  dplyr::select(Gene, padj, log2FoldChange)
write.table(upreg_sum,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_upreg_summary.txt",
            sep = ",",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_20["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_downreg_20_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_50["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_downreg_50_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_10["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_downreg_10_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)

# Summary of top 10 down-regulated significant genes (padj < 0.05)
downreg_sum <- downreg_10 %>%
  dplyr::select(Gene, padj, log2FoldChange)
write.table(downreg_sum,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_downreg_summary.txt",
            sep = ",",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_05["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_upreg_05_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_05["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/hs2_downreg_05_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(top_genes_data,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/top_dgea_genes.txt",
            sep = ",",
            row.names = FALSE,
            col.names = TRUE
)
...
# Save data
write.table(top_genes_data,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs2/all_top5_dgea_genes.txt",
            sep = ",",
            row.names = FALSE,
            col.names = TRUE
)
