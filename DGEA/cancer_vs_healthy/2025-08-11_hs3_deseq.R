...
# Load in sample raw data hs3 matrix and coldata
count_data <- read.csv("C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/healthy_stage3_rawcounts.csv", row.names = 1, check.names = FALSE)
condition <- read.csv("C:/Users/leahe/Documents/LIFE4137_independent_project/xena/clean_script/hs3/hs3_raw_col_data.csv", header = TRUE, row.names = 1)
...
res <- results(dds, name="condition_Stage3_HCC_vs_Healthy") # y (stage3) vs x control (healthy)
...
sum(res$padj < 0.01, na.rm=TRUE) # 15036
# Number of genes with padj < 0.05
sum(res$padj < 0.05, na.rm=TRUE) # 17965
...
which.min(res$padj) # 21429 - ENSG00000210196 gene
...
mean(stage3_gene_count[["count"]]) # 10.53191
median(stage3_gene_count[["count"]]) # 10.52298
...
ggplot(data=volcano, aes(x=log2FoldChange, y=-log10(padj), col=diffexpressed, label=label)) +
  ...
  ylim(-5, 200) +
  xlim(-10, 10) +
  geom_text_repel(max.overlaps = Inf, size = 3, col = "black")
...
fit
write.csv(as.data.frame(upreg_GO),file="C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/GO_analysis/upreg/hs3_upreg.csv")
...
fit
write.csv(as.data.frame(downreg_GO),file="C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/GO_analysis/downreg/hs3_downreg.csv")
...
write.table(upreg_20["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_upreg_20_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_50["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_upreg_50_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_10["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_upreg_10_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_20["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_downreg_20_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_50["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_downreg_50_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_10["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_downreg_10_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_10_sum,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_downreg_10_summary.txt",
            sep = ",",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_10_sum,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_upreg_summary.txt",
            sep = ",",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_05["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_upreg_05_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_05["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/hs3_downreg_05_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(top_genes_data,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/top_dgea_genes.txt",
            sep = ",",
            row.names = FALSE,
            col.names = TRUE
)
...
# Save data
write.table(top_genes_data,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs3/all_top5_dgea_genes.txt",
            sep = ",",
            row.names = FALSE,
            col.names = TRUE
)
