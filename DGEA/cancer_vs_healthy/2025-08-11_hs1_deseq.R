...
count_data <- read.csv("C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/healthy_stage1_rawcounts.csv", row.names = 1, check.names = FALSE)
condition <- read.csv("C:/Users/leahe/Documents/LIFE4137_independent_project/xena/clean_script/hs1/hs1_raw_col_data.csv", header = TRUE, row.names = 1)
...
res <- results(dds, name="condition_Stage1_HCC_vs_Healthy") # y (stage1) vs x control (healthy)
...
write.table(row.names(condition), 
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/sample_names.txt",
            sep=",",
            row.names = FALSE,
            col.names = FALSE
)
...
sum(res$padj < 0.01, na.rm=TRUE) # 16107
# Number of genes with padj < 0.05
sum(res$padj < 0.05, na.rm=TRUE) # 18910
...
with(res[topGene, ], {
  ...
  text(baseMean, log2FoldChange, topGene, pos=2, col="limegreen")
})
...
which.min(res$padj) #= 42234 - gene ENSG00000254772
# log count statistics of the top differentially expressed gene
healthy_gene_count <- clean_d %>%
  filter(condition=="Healthy")
mean(healthy_gene_count[["count"]]) # 14.71919
median(healthy_gene_count[["count"]])  # 14.69221

stage1_gene_count <- clean_d %>%
  filter(condition=="Stage1_HCC")
mean(stage1_gene_count[["count"]]) # 0.5
median(stage1_gene_count[["count"]]) # 0.5
...
# Label the top 5 up and down-regulated DEGs
...
ggplot(data=volcano, aes(x=log2FoldChange, y=-log10(padj), col=diffexpressed, label=label)) +
  ...
  ylim(-5, 350) +
  xlim(-10, 10) +
  geom_text_repel(max.overlaps = 13, size = 3, force = 10, col = "black")
...
fit
write.csv(as.data.frame(upreg_GO),file="C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/GO_analysis/upreg/hs1_upreg.csv")
...
fit
write.csv(as.data.frame(downreg_GO),file="C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/GO_analysis/downreg/hs1_downreg.csv")
...
write.table(upreg_50["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_upreg_50_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
            )
...
write.table(upreg_20["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_upreg_20_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_10["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_upreg_10_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)

# Summary of the top upregulated significant genes (padj < 0.05)
upreg_sum <- upreg_10 %>%
  dplyr::select(Gene, padj, log2FoldChange)
write.table(upreg_sum,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_upreg_summary.txt",
            sep = ",",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_50["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_downreg_50_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_20["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_downreg_20_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_10["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_downreg_10_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
# Top 10 down-regulated significant genes (padj < 0.05)
downreg_sum <- downreg_10 %>%
  dplyr::select(Gene, padj, log2FoldChange)
write.table(downreg_sum,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_downreg_summary.txt",
            sep = ",",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(upreg_05["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_upreg_05_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(downreg_05["Gene"],
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/hs1_downreg_05_genes.txt",
            sep = "",
            row.names = FALSE,
            col.names = FALSE
)
...
write.table(top_genes_data,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/top_dgea_genes.txt",
            sep = ",",
            row.names = FALSE,
            col.names = TRUE
)
...
# Save data
write.table(top_genes_data,
            file = "C:/Users/leahe/Documents/LIFE4137_independent_project/xena/removed_versions/hs1/all_top5_dgea_genes.txt",
            sep = ",",
            row.names = FALSE,
            col.names = TRUE
)
