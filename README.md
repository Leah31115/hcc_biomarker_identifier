...
Samples were filtered using the scripts within the [filter_samples folder](https://github.com/Leah31115/hcc_biomarker_identifier/tree/main/filter_samples). Paired Solid Tissue Normal (STN) healthy samples (ID ending -11) were paired to the cancer sample (ID ending -01) by their TCGA ID. Samples were filtered using the following packages: data.table, R.utils and tidyverse (Barrett et al, 2025; Bengtsson 2025; Wickham et al. 2019).
...
- Barrett T, Dowle M, Srinivasan A, Gorecki J, Chirico M, Hocking T, Schwendinger B, Krylov I. 2025. data.table: Extension of `data.frame`. doi:10.32614/CRAN.package.data.table. Available at https://doi.org/10.32614/CRAN.package.data.table. R package version 1.17.8 available at https://CRAN.R-project.org/package=data.table. Accessed 01/09/2025.
- Bengtsson H. 2025. R.utils: Various Programming Utilities. doi:10.32614/CRAN.package.R.utils. Available at https://doi.org/10.32614/CRAN.package.R.utils . R package version 2.13.0 available at https://CRAN.R-project.org/package=R.utils . Accessed 01/09/2025.
